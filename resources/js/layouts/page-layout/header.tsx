        ...
        <>
            ...
            <header className="container mx-auto flex h-fit items-center justify-between py-4">
                <h1 className="flex items-center gap-2 text-xl font-bold">
                    <img src={'/avatars/shadcn.jpg'} width={30} height={30} className="select-none rounded border shadow-md" alt="shadcn/ui" />
                    <span>Shadcn Admin</span>
                </h1>
                <nav className="flex items-center gap-4">
                    <Link target="_blank" href="https://github.com/binjuhor/shadcn-admin">
                        <Button
                            variant={'expandIcon'}
                            Icon={ArrowRight}
                            iconPlacement="right"
