...
export function NotFound() {
    return (
        <div className="container flex h-screen w-full flex-col items-center justify-center gap-6 overflow-y-auto">
            <svg width="135" height="87" focusable="false" fill="currentColor" stroke="currentColor" className="text-neutral-500">
            ...
            <div className="text-center">
                <h3 className="mb-1 text-xl font-semibold">Error 404: Page not found</h3>

                <p className="text-sm italic text-muted-foreground">This page isn't available. Try checking the URL or visit a different page.</p>
            </div>
